...
// TODO: find char limit of text 
// make notification last longer 
// find bigger photo for notification icon 
var text = [
...
"Alcohol and Memory: in a study examining memory and alcohol consumption, participants who drank alcohol only remembered 40-50% of information on a test after the first night, and only 60% after the the third night compared to the control group. (Sabia 2014). ", 
...
"Emotional Brain Function: sleep prepares the brain for next-day social and emotional functioning. Accumulated sleep loss leads to an amplification of negative emotions. (Walker, 2009; Zohar, 2005). ", 
...
"Driving While Sleepy: after 22 hours of going without sleep, a person's driving is worse than someone who is legally drunk. (Williamson, Feyer, 2000.)",
...
function addSleepmessages(){
  for (i = 0; i <= 12; i++) {
    var opt = {type: "basic", title: "Go to Sleep", message: text[i],iconUrl: "icon.png"}
    messages.push(opt);
  }
}
