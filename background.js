var now = new Date();
var millisTill11 = new Date(now.getFullYear(), now.getMonth(), now.getDate(), 18, 0, 0, 0) - now;
...
"Alcohol and Memory: people who drank alcohol only remembered 40-50% of information on a test after the first night, and only 60% after the the third night. (Sabia 2014). ", 
...
function addSleepmessages(){
  for (i = 0; i <= 12; i++) {
    var opt = {type: "basic", title: "Go to Sleep", message: text[i], priority:1, iconUrl: "book.png"}
    messages.push(opt);
  }
}
